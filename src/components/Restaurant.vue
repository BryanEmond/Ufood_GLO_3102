...
<div class="container mx-auto">
  ...
  <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-6 shadow-lg">
    <div class="flex border-2 border-gray-300 rounded-xl p-6 object-cover">
      <img class="object-cover rounded-xl shadow-lg" src="https://ufood.s3-us-west-2.amazonaws.com/pictures/d14999e4-4238-473d-8ff1-278f78498206.jpg">
    </div>
    <div class="flex border-2 border-gray-300 rounded-xl p-6 object-cover">
      <img class="object-cover rounded-xl shadow-lg" src="https://ufood.s3-us-west-2.amazonaws.com/pictures/5868b5f5-7524-40ae-b0cf-ae5eed07037a.jpg">
    </div>
